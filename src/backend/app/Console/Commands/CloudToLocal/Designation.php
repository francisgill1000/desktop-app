...
class Designation extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cloud-to-local:designation';
    ...
    public function handle()
    {
        ...
        $url = 'https://backend.mytime2cloud.com/api/designation';
        ...
        if ($response->successful()) {
            ...
            ModelDesignation::truncate();

            ModelDesignation::insert($payload);
